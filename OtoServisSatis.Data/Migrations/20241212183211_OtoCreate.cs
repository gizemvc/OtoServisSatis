...
{
    /// <inheritdoc />
    public partial class OtoCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MasaTipi = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", true, new DateTime(2024, 12, 12, 21, 32, 11, 601, DateTimeKind.Local).AddTicks(7537), "admin@otoservissatiis.tc", "admin", 1, "123456", "admin", "0850" });
